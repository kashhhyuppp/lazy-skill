/**
 * Google's G, in its brand colours rather than currentColor — Google's
 * sign-in guidelines require the mark keep them, so it deliberately does not
 * follow the theme like the GitHub glyph does.
 */
